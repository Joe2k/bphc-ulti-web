...
export default function posts(){
    ...
    const response = {
        "2023": [
          {
            "timestamp": "<date-time>",
            "picture": "https://res.cloudinary.com/deejstqqy/image/upload/v1681205937/SpyBITS_qmujxy.jpg",
