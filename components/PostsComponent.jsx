    ...
    return (
        <>
            <div className="mt-10 mb-10">
                ...
                <p className="font-normal text-gray-400 dark:text-gray-500">
                    {post.content}
                </p>
...
const YearComponent = ({ year, posts }) => {
    return (
        <div
            id={year}
            className="border mb-20 p-8 bg-white border-gray-200 rounded-lg drop-shadow-2xl dark:bg-gray-800 dark:border-gray-700"
        >
